...
const TEST_SCRIPTS: Array[String] = [
    ...
    "res://tests/unit/test_hull_impact_math.gd",
    "res://tests/unit/test_enemy_destruction_timeline.gd",
    "res://tests/unit/test_combat_audio_contract.gd",
    "res://tests/unit/test_combat_camera_impulse_state.gd",
    "res://tests/unit/test_practice_drone_steering.gd",
    "res://tests/unit/test_projectile_intercept_solver.gd",
    "res://tests/unit/test_tactical_dogfight_solver.gd",
    "res://tests/unit/test_enemy_fire_cadence.gd",
    "res://tests/unit/test_enemy_thruster_presentation_math.gd",
    "res://tests/unit/test_player_settings_service.gd",
    "res://tests/unit/test_velocity_marker_math.gd",
    ...
    "res://tests/integration/test_pulse_projectile_visuals.gd",
    ...
    "res://tests/integration/test_enemy_fighter_scene.gd",
    "res://tests/integration/test_enemy_thruster_visual_controller.gd",
    ...
    "res://tests/integration/test_camera_physics_interpolation.gd",
    "res://tests/integration/test_flight_room_settings_coordinator.gd",
    "res://tests/integration/test_pause_and_flight_room_milestone.gd",
    "res://tests/integration/test_flight_room_scene.gd",
    "res://tests/integration/test_combat_sandbox.gd",
    "res://tests/integration/test_combat_impact_presentation.gd",
    "res://tests/integration/test_enemy_destruction_presentation.gd",
    "res://tests/integration/test_combat_audio_controller.gd",
    "res://tests/integration/test_combat_camera_feedback.gd",
    "res://tests/integration/test_enemy_weapon_controller.gd",
    "res://tests/integration/test_tactical_dogfight_sandbox.gd",

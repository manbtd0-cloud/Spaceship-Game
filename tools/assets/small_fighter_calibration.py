...
def group_spatial_components(
    ...
    Some authored exhausts contain concentric inner and outer shells. Those shells are
    disconnected mesh islands but represent one nozzle. We agglomerate the nearest
    component centroids until the approved physical socket count is reached, then
    require strong separation between the resulting plume groups.
    """

...
|---|---|---|---|---|
| Small Sci-Fi Fighter | `assets/source/ships/player_candidates/small_sci_fi_fighter/` | Primary hero-interceptor candidate | License evidence pending centralization | Source preserved; Blender audit pending |
| The Ship | `assets/source/ships/player_candidates/the_ship/` | Secondary hero/heavy-ship candidate | License evidence pending centralization | Source preserved; Blender audit pending |
